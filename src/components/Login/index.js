...
class Login extends Component {
  ...
  componentDidMount() {
    document.title = 'Project by Vishnuvardhan Bunari'
  }
        ...
        <div className="login-form-container">
          <div className="small-device-logo-container">
            <img
              ...
              src="https://res.cloudinary.com/vishnuvardhan-bunari/image/upload/v1652874330/TastyKitchens/Rectangle_1457_z2svbb.png"
              alt="website login"
            />
          </div>
